...
public class Level2 extends AppCompatActivity {
        ...
        switchBtn.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    if (homeMusic == null) {
                        homeMusic = MediaPlayer.create(Level2.this, R.raw.level2);
                    }
                    ...
                    Toast.makeText(Level2.this, "On", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(Level2.this, "Off", Toast.LENGTH_SHORT).show();
                }
            }
        });
            ...
            public void onClick(View v) {
                if (answered == false) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                        ...
                        Toast.makeText(Level2.this, "Select The Answer", Toast.LENGTH_SHORT).show();
                    }
                }
                else {
                    showNextQuestion();
    ...
    private void finishQuiz() {
        if (correctScore >= totalQuestion * 0.5){
            Intent intent = new Intent(Level2.this, Congrats.class);
            intent.putExtra("score", correctScore);
            intent.putExtra("totalQuestions", totalQuestion);
            intent.putExtra("source_level","Level2");
            startActivity(intent);
        }
        else {
            Intent intent = new Intent(Level2.this, Failed.class);
            intent.putExtra("score", correctScore);
            intent.putExtra("totalQuestions", totalQuestion);
            intent.putExtra("source_level","Level2");
            startActivity(intent);
