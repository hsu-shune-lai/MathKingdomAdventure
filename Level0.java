...
public class Level0 extends AppCompatActivity {
        ...
        switchBtn.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    if (homeMusic == null) {
                        homeMusic = MediaPlayer.create(Level0.this, R.raw.level0);
                    }
                    ...
                    Toast.makeText(Level0.this, "On", Toast.LENGTH_SHORT).show();

                } else {
                    homeMusic.pause();
                    soundOff.setVisibility(View.VISIBLE);
                    soundOn.setVisibility(View.INVISIBLE);
                    Toast.makeText(Level0.this, "Off", Toast.LENGTH_SHORT).show();
                }
            }
        });
            ...
            public void onClick(View v) {
                if (answered == false) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                        ...
                        Toast.makeText(Level0.this, "Select The Answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
    ...
    private void finishQuiz() {
        if (correctScore >= totalQuestion * 0.5) {
            Intent intent = new Intent(Level0.this, Congrats.class);
            intent.putExtra("score", correctScore);
            intent.putExtra("totalQuestions", totalQuestion);
            intent.putExtra("source_level", "Level0");
            startActivity(intent);
        } else {
            Intent intent = new Intent(Level0.this, Failed.class);
            intent.putExtra("score", correctScore);
            intent.putExtra("totalQuestions", totalQuestion);
            intent.putExtra("source_level", "Level0");
            startActivity(intent);
